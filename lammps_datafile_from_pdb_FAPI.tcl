...
set selHa [atomselect top {name Ha}]
$selHa set type Ha
$selHa set mass 1.00800
$selHa set charge 0.22250000 
set numHa [$selHa num]
set posHa [$selHa get {x y z}]
set indexHa [$selHa get index]
...
# Select neighboring atoms.
  ...
  foreach new_pos $posHa ind2 $indexHa {
...
###CNN####################
#for {set a 194; set b 192; set c 193; set d 199} {$a < $natoms} {incr a 8; incr b 8; incr c 8; incr d 8} {
#       lappend impropers [list C-N-N-Ha  $a $b $c $d]
#}
#for {set a 192; set b 194; set c 195; set d 196} {$a < $natoms} {incr a 8; incr b 8; incr c 8; incr d 8} {
#       lappend impropers [list N-C-H-H  $a $b $c $d]
#}
#for {set a 193; set b 194; set c 197; set d 198} {$a < $natoms} {incr a 8; incr b 8; incr c 8; incr d 8} {
#       lappend impropers [list N1-C1-H1-H1  $a $b $c $d]
#}
#
...
topo writelammpsdata data.MAPI full
